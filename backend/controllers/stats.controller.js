...
export const getDashboardStats = async (req, res) => {
  try {
    ...
    // Filter out cancelled or refunded orders for Revenue calculation
    ...
    // Orders are already sorted by created_at desc from the query
    ...
    console.error("Stats Error (Supabase):", err);
